var ddfooterOptions = {
footerId: "ddfooter",
linkIdTofooterHtml: "ddfooterLink",
...
var ddfooter = new Ddfooter(ddfooterOptions);

/* footercool Drop Down footer v2015.10.26 Copyright www.footercool.com */
function Ddfooter(k) {
    "use strict";
    var p = function(a, b) {
    ...
    function x() {
        d(c, "footer-icon-active") && c[j]()
    }
    
    function jb(s, e) {
        var f = g.activeElement;
        if (f == c) {
            if (e == 9) !d(c, "footer-icon-active") && c[j]();
            if (e == 27) {
                x();
                c.blur()
            }
                ...
                if (b[a]) {
                    ...
                    if (c) {
                        ...
                        c[j] = function(a) {
                            ...
                            if (b[B] == 0) {
                                n(0);
                                J(this, "footer-icon-active")
                            } else K(this, "footer-icon-active");
                            s(a)
                        };
